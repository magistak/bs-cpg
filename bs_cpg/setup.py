...
# %% auto 0
__all__ = ['CONFIG_FILE', 'SUBDIR_NAME', 'sample_df', 'get_base_data_path', 'read_sample_cpg']
...
def read_sample_cpg(columns: list = None, force_download: bool = False):
    ...
    Examples:
        >>> # Load the entire sample dataset
        >>> df = read_sample_cpg()
        >>> 
        ...
        >>> df_fresh = read_sample_cpg(force_download=True)
    """
...
# Example: Load sample data with specific columns
sample_df = read_sample_cpg(["chromosome", "pos"])
sample_df.head()
