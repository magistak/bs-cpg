...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_download_processed_geo.ipynb.

# %% auto 0
__all__ = ['memory', 'Geofetcher']

# %% ../nbs/00_download_processed_geo.ipynb 5
...
# %% ../nbs/00_download_processed_geo.ipynb 6
...
# %% ../nbs/00_download_processed_geo.ipynb 7
...
# %% ../nbs/00_download_processed_geo.ipynb 12
#|eval: false
# Example: Set up a Geofetcher for downloading
# geof = Geofetcher(
#     processed=True, 
#     data_source="all", 
...
# %% ../nbs/00_download_processed_geo.ipynb 15
#|eval: false
# Example: View the sample table
